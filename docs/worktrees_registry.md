...
| `/Users/dmitrijfabarisov/Projects/Mango_noncontentful_call_memory_integration_20260804` | `main`, активная последовательная интеграция | Ветка `claude/timeline-final-20260803` обработана и отклонена: прямой merge дублирует механизмы, а минимальный вариант исторической оплаты не прошёл брендовый и смысловой гейты. Production/test diff снят, доказательства сохранены в audit pack. | Использовать для следующего донора после фиксации результата; удалять worktree только по решению владельца. |
| `/Users/dmitrijfabarisov/Projects/Mango_critical_gates_20260731` | `codex/call-dialogue-timing-integration-20260803`, активная интеграция | Проверка и минимальное поглощение полезного из старой ветки таймингов звонков на актуальном `main`; live, ASR и реальные данные не запускаются. | После тестов, независимого аудита и вливания в `main` запросить снятие worktree; ветку удалить только после поглощения. |
