...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/messages29_phone_history_full_20260410"
...
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/messages29_phone_history_full_20260410.db"
