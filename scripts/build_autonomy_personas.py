...
ACTION_CONTRACT_VERSION = "action_intent_v2_expected_send_materials_2026_06_14"
...
def expected_action_from_deal_card(deal_card: Mapping[str, Any]) -> Mapping[str, Any]:
    ...
    if truthy(preconditions.get("p0_required")):
        ...
        reason = "Client asks for trial/diagnostics and product direction is selected; bot action list uses materials instead of trial booking."
        ...
        action = "answer_only"
        reason = "Preconditions for payment, materials or lead capture are not met."
    return {
