...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/overnight_full_asr_priority_2000_20260415"
...
export MANGO_UI_RECORDINGS_DIR="${WAVE_ROOT}/batch_full_cycle"
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/overnight_full_asr_priority_2000_20260415.db"
