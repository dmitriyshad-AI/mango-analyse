...
def build_markdown() -> str:
    ...
    lines.extend(
        [
            ...
            "|---|---|---|---|",
            f"| `{SEMANTIC_READING_CLASSES_ENV}=sense_seats,off_topic,slots_gsf` | ON only | enable three reader insertions and trace | P0, brand, metadata-only off-topic, slot leak tests |",
            "",
            "## Notes",
            "",
