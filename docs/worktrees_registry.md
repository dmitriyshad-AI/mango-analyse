...
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/model-owned-semantics-cleanup-20260811` | `codex/model-owned-semantics-cleanup-20260811`; базовый SHA `8cfe4c89` | Удаление повторного regex-классификатора действий и аудит старого pre-model контекста Wappi; Timeline и Calls не затрагиваются. | После audit pack, слияния в `main` и отдельного подтверждения владельца. |
