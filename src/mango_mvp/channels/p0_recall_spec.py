...
REFUND_RE = re.compile(
    ...
    r"|\bденьги\s+назад\b"
    r"|\b(?:снят\w*|снять)[^.!?\n]{0,80}(?:реб[её]н\w*|с\s+(?:кружк\w*|курс\w*|заняти\w*|обучени\w*|групп\w*)|запис\w*)"
    r"|\b(?:хочу|нужно|надо|прошу|можно)\s+(?:снять|отписа\w*)[^.!?\n]{0,80}"
    r"(?:реб[её]н\w*|с\s+(?:кружк\w*|курс\w*|заняти\w*|обучени\w*|групп\w*)|от\s+(?:заняти\w*|обучени\w*))"
