...
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/model-owned-semantics-cleanup-20260811` | `codex/semantic-routing-cleanup-wave2-20260811`; базовый SHA `81105c08` | Вторая волна: удаление только доказанно невызванных смысловых наблюдателей и regex-ремонтников; Timeline и Calls не затрагиваются. | После audit pack, слияния в `main` и отдельного подтверждения владельца. |
