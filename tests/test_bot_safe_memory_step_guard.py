...
def test_bot_safe_memory_step_guard_marks_soft_next_step_without_rewriting() -> None:
    result = _result(
...
def test_bot_safe_memory_step_guard_marks_soft_pick_or_check_step_without_rewriting() -> None:
    result = _result(
...
def test_unconfirmed_contact_data_claim_guard_marks_missing_phone_claim_without_rewriting() -> None:
    result = _result(
...
def test_no_memory_step_frame_guard_marks_baseline_without_rewriting() -> None:
    result = _result(
