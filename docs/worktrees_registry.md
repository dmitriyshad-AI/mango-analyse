...
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/development-process-token-budget-20260825` | `373b8ca9`, `codex/development-process-token-budget-20260825` | Узкая правка лимитов повторных аудитов и расхода токенов процесса разработки. | После проверки, коммита и слияния владельцем. |
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/calls-neutral-analysis-fix-20260824` | `f9a9d96a`, `codex/calls-neutral-analysis-fix-20260824` | Исправление определения сторон стереозвонка и проверка на 25 реальных звонках. | После проверки, передачи на M1 и слияния владельцем. |
