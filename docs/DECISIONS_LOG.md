...
сообщения Telegram, но до записи state, допустим один повтор; смешение чатов или
брендов недопустимо. Новый store, feature flag, зависимость и второй Telegram
runtime не создаются.
