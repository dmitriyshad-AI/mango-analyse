...
## Summary
- facts_total: `1053`
- client_allowed_facts: `673`
- source_registry_total: `11`
- approval_queue_items: `1031`
- approval_queue_by_type: `{'price': 49, 'discount': 68, 'promocode': 13, 'installment': 31, 'tax': 40, 'matkap': 42, 'deadline': 133, 'camp_lvsh': 120, 'camp_zvsh': 3, 'program': 285, 'documents': 67, 'location': 1, 'teacher': 13, 'refund': 18, 'policy': 13, 'process': 60, 'contacts': 3, 'availability': 1, 'format': 4, 'payment': 2, 'camp_city': 17, 'intensive': 34, 'contact': 14}`
