...
> **УСТАРЕЛО.** Снимок от 2026-05-23 сохранён только для истории. Текущую
> правду брать из `AGENTS.md`, `README.md`, `ARCHITECTURE.md`,
> `docs/PROJECT_NOW.md`, `docs/RUNBOOK.md` и `docs/DECISIONS_LOG.md`.

Дата обновления: 2026-05-23

Назначение: исторический снимок состояния проекта.
