        ...
        if "онлайн" in client or known.get("format") == "онлайн" or "фрагмент" in client:
            ...
            if _asks_trial_fragment_data_or_process(client):
                return (
                    ...
                    "Для подбора фрагмента достаточно класса, предмета и формата; личные документы, договор или оплату сейчас присылать не нужно. "
                    "Передам менеджеру запрос на фрагмент.",
                    "draft_for_manager",
                    (),
                )
            return (
