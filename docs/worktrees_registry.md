...
Обновлено: 2026-08-25. Источник факта: `git worktree list --porcelain`,
...
|---|---|---|---|
| `/Users/dmitriy/Projects/Mango_m1_calls_service_fast_value_20260811` | `codex/m1-calls-service-fast-value-20260811`; базовый SHA `53661bb402b376755f0ac4bff59628f8933f4f0f` | Активный worktree Codex-трека быстрой Calls-службы на M1: только код и синтетика, без реального ASR/Resolve/Analyze, launchd и внешних записей. | После атомарных коммитов по зонам, audit pack, push в отдельную yandex-ветку и приёмки главным Codex. |
| `/Users/dmitriy/Projects/Mango_m1_calls_real_service_final_20260812` | `codex/m1-calls-real-service-final-20260812`; проверенный code base `86ea48520198c24918effb18cd2779f65e0c0909`; стартовый документальный HEAD `a887d6edc98c0b96a3d09889758090d45a2b8e11` | Финальный трек запуска Mango Calls: код, тесты, dry-run и owner-gates; Mango API, реальные ASR/Resolve/Analyze, runtime, публикация и launchd только по отдельным подтверждениям Дмитрия. | После лестницы 1 -> 0 -> 10 -> сутки -> 72 часа, передачи audit pack и отдельного решения владельца; `main`, stable runtime и Customer Timeline worktree не переключать. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.gigaam-v3-batch.20260814` | `codex/gigaam-v3-batch-20260814`; база `ee6f20a3c47afd9a19b36c71199e06a161c252e3` | Изолированная оптимизация GigaAM 0.2: пакетная обработка в одном процессе, синтетические и локальные read-only замеры; live-служба остаётся на финальном worktree до отдельного cutover. | После тестов, audit pack, контролируемой канарейки и принятия или отклонения изменения. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.gigaam-batch.2Wg1KM` | `codex/gigaam-batch-20260814`; база `ee6f20a3c47afd9a19b36c71199e06a161c252e3` | Остановленный прототип пакетной обработки на GigaAM 0.1; live не использует, изменения сохраняются только для аудита эксперимента. | После фиксации результатов и отдельного решения владельца об удалении worktree. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.gigaam-parallel.JGmNSc` | `codex/gigaam-parallel-20260814`; база `ee6f20a3c47afd9a19b36c71199e06a161c252e3` | Чистый worktree эксперимента с несколькими GigaAM-процессами; канарейка отклонена, live вернулся к одному процессу. | После фиксации результатов и отдельного решения владельца об удалении worktree. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.selective-gigaam-v2.A77tnJ` | `codex/selective-gigaam-v2-20260814`; база `ee6f20a3c47afd9a19b36c71199e06a161c252e3` | Остановленный прототип выборочного запуска GigaAM; live не использует, смысловой аудит выявил незакрытые риски. | После исправления/аудита либо отдельного решения владельца об удалении worktree. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.google-publisher.20260815` | `codex/google-publisher-20260815`; база `0ef7ff99d5b740c49adc9fa542107c55a3e14821` | Изолированная замена рабочего Google publisher: код, тесты, read-only shadow и точечный cutover только publisher; Capture/Whisper/GigaAM/Resolve/Analyse не переключаются. | После 24-часовой приёмки нового единственного writer, audit pack и отдельного решения владельца. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.asr-single-call-progress.20260818` | `codex/asr-single-call-progress-20260818`; SHA `9d3f0f64fa6bf8bc2ed3a985d4f6b17b4afe8475` | Изолированный трек прогресса и watchdog одного ASR-звонка; текущий publisher его не изменяет. | После приёмки соответствующего ASR-трека и отдельного решения владельца. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.m4-handoff.20260816` | `codex/mango-calls-m4-handoff-20260816`; SHA `c18ca4c830b9ac122363b2369567add37a11ca8d` | Пакет передачи Calls на M4; текущий M1 publisher его не изменяет. | После подтверждения приёма пакета на M4 и отдельного решения владельца. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.pipeline-stall-watchdog.20260818` | `codex/pipeline-stall-watchdog-20260818`; SHA `435f7d7f6fb8448518120e44ebcfecb32976ec8c` | Активный production-worktree конвейера Capture/ASR/Resolve/Analyze и локального watchdog. | Только после отдельного cutover службы и проверки отсутствия живых PID. |
| `/Users/dmitriy/Projects/Mango_m1_calls_provider_selective_integration_20260823` | `codex/m1-calls-provider-selective-integration-20260823`; SHA `93c73fcdffefa5811bb0ebc7eb810b807608b62e` | Остановленная первая попытка интеграции provider-selective пилота; production её не использует. | После сохранения доказательств и отдельного решения владельца. |
| `/Users/dmitriy/Projects/Mango_m1_calls_provider_selective_integration_20260824` | `codex/m1-calls-provider-selective-integration-20260824`; SHA `f9a9d96a863803491860df3c12ca615db59597af` | Чистая интеграционная ветка provider-selective пилота; не подключена к production. | После завершения пилота, независимой приёмки и отдельного решения владельца. |
| `/Users/dmitriy/Codex projects/Mango Analyse m1 pro/.pipeline-interactive.20260814` | `codex/pipeline-interactive-20260814`; SHA `0ef7ff99d5b740c49adc9fa542107c55a3e14821` | Активный чистый live-worktree конвейера звонков с Capture/Whisper/GigaAM/Resolve/Analyse; publisher-задача его не изменяет и не переключает. | Только после отдельного controlled cutover основного конвейера и проверки отсутствия живых PID. |
| `/Users/dmitriy/Projects/Mango_m1_customer_timeline_followup_20260811` | `codex/m1-customer-timeline-followup-20260811`; текущий SHA `c58225be2108f43212d7d41e46759ddea3b146d7` | Активный Customer Timeline follow-up другого исполнителя; Calls-worktree его ветку, файлы и незакоммиченные изменения не затрагивает. | Только владельцем Customer Timeline после завершения и приёмки его задачи. |
| `/Users/dmitriy/Projects/Mango_m1_customer_timeline_release_evidence_20260811` | `codex/m1-customer-timeline-release-evidence-20260811`; базовый SHA `8cfe4c8918ba436decf55da1ead74fbcdf8f531e` | Единственный worktree M1 для чистой release-evidence приёмки Customer Timeline: incremental convergence, S10/S100 и audit-only измерения без Calls, live и внешних записей. | После атомарных коммитов, передачи audit pack и независимой приёмки главным Codex; Calls D2 и другие worktree не затрагивать. |
| `/Users/dmitriy/Projects/Mango_m1_customer_timeline_exam_regrade_20260812` | `codex/m1-customer-timeline-exam-regrade-20260812`; текущий SHA `5ef27229a38a75ec5f60d3a6e7ecbb5b7218183d` | Изолированная повторная приёмка Customer Timeline другого трека; Calls её ветку и файлы не затрагивает. | Только владельцем Customer Timeline после отдельной приёмки. |
| `/Users/dmitriy/Projects/Mango_m1_customer_timeline_working_final_20260812` | `codex/m1-customer-timeline-working-final-20260812`; текущий SHA `740d93e7ffb34997433a78e16073657bdf463d85` | Активный финальный трек Customer Timeline с собственным ТЗ; Calls работает только в своём зарегистрированном worktree. | Только владельцем Customer Timeline после завершения его ТЗ. |
| `/Users/dmitriy/Projects/Mango_m1_calls_cutover_20260807` | `codex/m1-calls-cutover-20260807`; базовый SHA `f8faabf1d442261023605ee3285deb3b2a278cf9` | Предыдущий изолированный Calls-трек; текущая fast-service задача его не использует и не изменяет. | Только владельцем предыдущего трека после его отдельной приёмки. |
