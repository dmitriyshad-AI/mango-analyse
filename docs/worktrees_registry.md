...
|---|---|---|---|
| `/Users/dmitriy/Projects/Mango_m1_calls_fresh_priority_20260909` | `codex/m1-calls-fresh-priority-20260909`; база `435f7d7f6fb8448518120e44ebcfecb32976ec8c` | Изолированная минимальная правка приоритета свежих звонков в очередях Whisper, GigaAM, Resolve и Analyze; live-служба остаётся на прежнем worktree до проверки и отдельного переключения. | После тестов, контролируемого переключения и подтверждения, что новые звонки снова появляются в Google-таблице. |
