...
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/calls-neutral-analysis-fix-20260824` | `f9a9d96a`, `codex/calls-neutral-analysis-fix-20260824` | Модельное определение ориентации двух физических дорожек звонка; отдельный Calls-worktree. | После коммита, независимого аудита, передачи M1 и отдельной приёмки владельцем Calls-трека. |
