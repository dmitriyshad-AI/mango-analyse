...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/messages31_phone_history_full_20260414"
...
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/messages31_phone_history_full_20260414.db"
