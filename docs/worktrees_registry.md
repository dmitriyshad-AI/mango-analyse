...
| `/Users/dmitrijfabarisov/Projects/Mango_timeline_owner_relink_fix_20260805` | `codex/timeline-final-data-gates`; SHA через `git rev-parse HEAD` | Финальные family/Wappi/attendance data-гейты на staging-клоне. | После тестов, audit pack, слияния в `main` и отдельного подтверждения владельца. |
