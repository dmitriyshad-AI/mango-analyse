...
- Блок D реализован в текущем рабочем дереве и должен быть зафиксирован отдельным коммитом.
...
6. `D` - связь каталога вопросов и deal-aware gate. Статус: выполнено в коде.
7. `E` - customer timeline как read-only источник истории клиента. Следующий блок.
...
После коммита Блока D перейти к Блоку E:

- встроить customer timeline как read-only источник истории;
- сохранить fallback на текущие snapshot-источники;
