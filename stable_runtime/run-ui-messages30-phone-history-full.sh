...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/messages30_phone_history_full_20260412"
...
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/messages30_phone_history_full_20260412.db"
