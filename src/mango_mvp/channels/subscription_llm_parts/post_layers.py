...
def build_semantic_output_regen_prompt(
    *,
    ...
    return (
        ...
        "Если риск можно убрать удалением спорного фрагмента, удали его, а не заменяй новой конкретикой. "
        "Дни недели, время суток, точное время, частоту и длительность занятий сохраняй только тогда, "
        "когда они прямо присутствуют в приведённых фактах или вопросе клиента; не выводи одно из другого. "
