...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/messages28_full_20260407"
...
mkdir -p "${WAVE_ROOT}/transcripts_retry1"
...
export MANGO_UI_RECORDINGS_DIR="${WAVE_ROOT}/batch"
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/messages28_full_20260407_retry1.db"
export MANGO_UI_EXPORT_DIR="${WAVE_ROOT}/transcripts_retry1"
