...
| `/Users/dmitrijfabarisov/Projects/Mango_timeline_owner_relink_fix_20260805` | `codex/timeline-tallanto-money-owner-20260806`; SHA через `git rev-parse HEAD` | Сведение дублированного money-owner resolver к каноническому Tallanto student owner; только код, тесты и APFS-клон staging. | После лестницы 1→10→всё, audit pack, слияния в `main` и отдельного подтверждения владельца. |
