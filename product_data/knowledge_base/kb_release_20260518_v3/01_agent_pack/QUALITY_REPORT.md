...
- approval_queue_by_type: `{'price': 138, 'discount': 51, 'promocode': 11, 'installment': 18, 'tax': 30, 'matkap': 40, 'refund': 2, 'deadline': 26, 'camp_lvsh': 64, 'camp_zvsh': 2, 'program': 172, 'intensive': 42, 'documents': 66, 'contact': 13, 'location': 2, 'teacher': 11, 'policy': 4, 'camp_city': 13}`
