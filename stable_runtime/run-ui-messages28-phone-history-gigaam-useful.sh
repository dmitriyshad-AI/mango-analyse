...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/messages28_phone_history_gigaam_useful_20260409"
...
export MANGO_UI_RECORDINGS_DIR="${WAVE_ROOT}/batch_gigaam_useful"
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/messages28_phone_history_gigaam_useful_20260409.db"
...
export MANGO_UI_STAGE_LIMIT="12"
