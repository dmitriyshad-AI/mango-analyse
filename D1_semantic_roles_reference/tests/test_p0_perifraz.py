...
СТАТУС НА 2026-05-25: КРАСНЫЙ (детектор ещё не расширен — это ожидаемо).
Станет зелёным, когда Codex расширит REFUND_RE/PAYMENT_DISPUTE_RE/LEGAL_RE и починит
ложное срабатывание на «вернуться к теме цены». Это приёмка для части 1.2.
