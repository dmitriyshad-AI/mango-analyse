...
| `/Users/dmitrijfabarisov/Projects/Mango_timeline_owner_relink_fix_20260805` | `codex/timeline-stage4b-nightly-20260806`; SHA через `git rev-parse HEAD` | Корневая починка сохранения mail-visibility и обязательная интеграция существующего Stage4b в nightly; только код, тесты и APFS-клон staging. | После лестницы 1→10→100→всё на клоне, audit pack, слияния в `main` и отдельного подтверждения владельца. |
