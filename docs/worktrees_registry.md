...
| `/Users/dmitrijfabarisov/Projects/Mango_business_journey_traces_wave1_20260803` | `codex/business-journey-traces-wave1-20260803`, чистый | Отдельная работа другого исполнителя над первыми сквозными бизнес-сценариями; текущая интеграция звонков его не использует. | Не переключать и не изменять; после отдельной приёмки и поглощения запросить снятие. |
