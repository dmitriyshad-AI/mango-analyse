...
- approval_queue_items: `961`
- approval_queue_by_type: `{'price': 48, 'discount': 67, 'promocode': 13, 'installment': 27, 'tax': 40, 'matkap': 50, 'deadline': 133, 'camp_lvsh': 121, 'camp_zvsh': 3, 'program': 290, 'documents': 65, 'teacher': 13, 'refund': 18, 'policy': 8, 'camp_city': 17, 'intensive': 34, 'contact': 14}`
