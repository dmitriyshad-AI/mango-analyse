...
| `/Users/dmitrijfabarisov/Projects/Mango_calls_tzv_20260712` | `1180902` | `codex/tzv-calls-schedule-brand` | Параллельная задача расписания звонков/бренда. | Не трогать. |
...
| `/Users/dmitrijfabarisov/Projects/Mango_tallanto_freshness_pilot_20260712` | `7126f6d` | `codex/tallanto-freshness-publish-amo-pilot-20260712` | Параллельный трек свежести Tallanto. | Не трогать. |
| `/Users/dmitrijfabarisov/Projects/Mango_timeline_main_consolidation` | `7126f6d` | `codex/mail-three-stage-worktree-hygiene` | Текущая задача: три стадии почты и порядок worktree. | Единственный write-worktree этой задачи. |
...
| `/Users/dmitrijfabarisov/Projects/Mango_z0_z1_latch_seats_20260712` | `7615d5e` | `codex/z0-z1-latch-seats-20260712` | Параллельная задача latch/seats. | Не трогать. |
