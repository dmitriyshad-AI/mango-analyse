...
| `/Users/dmitrijfabarisov/Projects/Mango_critical_gates_20260731` | `codex/critical-gates-integration-20260731`, активная интеграция | Startup-гейт публичного Telegram, Wappi-оповещение, карта ADR-003, теневой P0 и объединение с актуальным `main`; live не запускался. | После тестов, вливания в `main` и проверки отсутствия процессов запросить снятие worktree; ветку удалить только после поглощения. |
