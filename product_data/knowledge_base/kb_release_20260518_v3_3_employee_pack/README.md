...
- formal_pass: `True`
- semantic_pass: `True`
- client_safe_facts: `360`
- manager_only_or_internal_facts: `304`
- Фотон client-safe facts: `184`
- УНПК client-safe facts: `176`
- Smoke 50: `FOTON rows=20, UNPK rows=20, errors=0, brand_violations=0`
