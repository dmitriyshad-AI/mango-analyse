...
- Proof shadow renderer candidates: `0`
...
- `wappi_pair_missing_72h_002#1` route=`draft_for_manager` action=`answer_question` class=`fact_assertion_required` next=`fix_proof_axis_alignment` confidence=`0.86`
...
- `wappi_pair_missing_72h_003#1` route=`manager_only` action=`check_availability` class=`fact_assertion_required` next=`fact_verification_or_retrieval_needed` confidence=`0.92`
  ...
  - review: What exact fresh client-safe fact would justify a self-answer?
- `wappi_pair_missing_72h_020#1` route=`bot_answer_self_for_pilot` action=`handoff_manager` class=`fact_assertion_required` next=`no_current_route_leverage` confidence=`0.93`
  ...
  - review: What exact fresh client-safe fact would justify a self-answer?
- `p0_model_led_pos_how_next#1` route=`draft_for_manager` action=`answer_question` class=`danger_adjacent_do_not_lower` next=`danger_adjacent_do_not_lower` confidence=`0.86`
...
- `p0_model_led_pos_anxiety_level#1` route=`draft_for_manager` action=`handoff_manager` class=`danger_adjacent_do_not_lower` next=`danger_adjacent_do_not_lower` confidence=`0.82`
  - blockers: `danger_adjacent, frame_marks_operational_or_manager_risk, requested_action_not_safe_reference`
  - review: Keep out of active candidates because the dialog is close to P0/money/fabrication.
- `ra1_foton_address_and_trial#1` route=`bot_answer_self_for_pilot` action=`enroll` class=`fact_assertion_required` next=`no_current_route_leverage` confidence=`0.93`
  - blockers: `already_self_or_no_route_leverage, requires_verified_fact_assertion, frame_marks_operational_or_manager_risk, requested_action_not_safe_reference`
  - review: What exact fresh client-safe fact would justify a self-answer?
- `ra1_foton_platform_and_price#1` route=`manager_only` action=`answer_question` class=`fact_assertion_required` next=`fact_verification_or_retrieval_needed` confidence=`0.88`
  - blockers: `manager_only_policy, requires_verified_fact_assertion, frame_marks_operational_or_manager_risk`
  - review: What exact fresh client-safe fact would justify a self-answer?
- `cf142_pos_unpk_camp_dates_signup#1` route=`bot_answer_self_for_pilot` action=`check_availability` class=`fact_assertion_required` next=`no_current_route_leverage` confidence=`0.86`
  - blockers: `already_self_or_no_route_leverage, requires_verified_fact_assertion, frame_marks_operational_or_manager_risk, requested_action_not_safe_reference`
  - review: What exact fresh client-safe fact would justify a self-answer?
- `cf142_pos_unpk_camp_dates_signup#2` route=`bot_answer_self_for_pilot` action=`answer_question` class=`fact_assertion_required` next=`no_current_route_leverage` confidence=`0.86`
  - blockers: `already_self_or_no_route_leverage, requires_verified_fact_assertion, frame_marks_operational_or_manager_risk`
  - review: What exact fresh client-safe fact would justify a self-answer?
- `cf142_pos_unpk_exam_group_signup#1` route=`bot_answer_self_for_pilot` action=`check_availability` class=`fact_assertion_required` next=`no_current_route_leverage` confidence=`0.92`
  - blockers: `already_self_or_no_route_leverage, requires_verified_fact_assertion, frame_marks_operational_or_manager_risk, requested_action_not_safe_reference`
  - review: What exact fresh client-safe fact would justify a self-answer?
- `cf142_p0_unpk_paid_transfer#1` route=`bot_answer_self_for_pilot` action=`check_availability` class=`danger_adjacent_do_not_lower` next=`no_current_route_leverage` confidence=`0.86`
  ...
  - review: Keep out of active candidates because the dialog is close to P0/money/fabrication.
- `cf142_fabrication_unpk_camp_medical#1` route=`bot_answer_self_for_pilot` action=`check_availability` class=`danger_adjacent_do_not_lower` next=`no_current_route_leverage` confidence=`0.86`
  - blockers: `already_self_or_no_route_leverage, requires_verified_fact_assertion, danger_adjacent, frame_marks_operational_or_manager_risk, requested_action_not_safe_reference`
  - review: Keep out of active candidates because the dialog is close to P0/money/fabrication.
...
- source fact brand index collisions: `5`
- shadow renderer candidates: `0`
...
- `blocked_source_axis_mismatch`: `6`
- `source_text_ready`: `2`
- `blocked_bot_template_required`: `1`

### Text policy readiness

- `blocked_source_axis_mismatch`: `7`
- `source_text_ready_requires_nonquote_policy`: `2`
...
### Shadow text renderer

- `blocked_source_axis_mismatch`: `7`
- `blocked_unsupported_structured_value`: `2`

### Source fact alignment

- `blocked_source_axis_mismatch`: `7`
- `aligned_covers_missing_fact_axis`: `2`
