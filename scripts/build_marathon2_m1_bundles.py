...
`subject` — часть письма для темы и контекста, но не самостоятельное доказательство оплаты,
возврата, договора, записи или суммы: такие факты должны подтверждаться в `full_clean_text`
или структурных полях письма.
