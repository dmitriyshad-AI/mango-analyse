...
| `/Users/dmitrijfabarisov/Projects/Mango_calls_quality_v3_m4_20260816` | `codex/mango-calls-quality-v3-m4-20260816`; база `c18ca4c830b9ac122363b2369567add37a11ca8d` | Изолированная реализация качества Mango Calls v3: только код, синтетические тесты и пакет передачи на M1; без live API, ASR, Resolve/Analyze и внешних записей. | После независимой приёмки, push ветки и отдельного решения владельца о слиянии или удалении. |
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/kb-owner-update-20260813` | `codex/kb-owner-update-20260813`; SHA `2438ec20733b43c7ebf4bb078e9e90a5beb54357` | Изолированный worktree другого исполнителя по базе знаний; текущая Calls-задача его не использует и не изменяет. | Только владельцем KB-трека после его отдельной приёмки. |
| `/Users/dmitrijfabarisov/Projects/Mango analyse/.codex_workers/unpk-partnership-playbook-20260816` | `codex/unpk-partnership-playbook-20260816`; SHA `5fe84024062b2a12d2920262a5c7f1a9f88990c5` | Изолированный worktree другого исполнителя по партнёрскому треку УНПК; текущая Calls-задача его не использует и не изменяет. | Только владельцем партнёрского трека после его отдельной приёмки. |
