...
Пять ТЗ реализованы в истории выпуска, а актуальная ветка
`codex/calls-utm-google-v3-20260822` добавляет 18-столбцовый UTM-контракт и
передаётся M1 по инструкции
...
согласованного бюджета запрещён. Решение D-128 от 22.08.2026 заменило прежний
17-столбцовый план: первые 16 столбцов сохраняются, Q содержит основания
выводов, R — UTM и страницу. Старый лист не мигрируется автоматически.
