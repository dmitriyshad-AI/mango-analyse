> FAIL 2026-08-22 19:53 | ветка codex/calls-utm-google-v3-20260822 | codex | причина: Старый 16-столбцовый cutover не завершён и заменён решениями D-124/D-128; продолжать его нельзя, актуальное ТЗ — 2026-08-22_TZ_CALLS_LIVE_GOOGLE_UTM.md.
