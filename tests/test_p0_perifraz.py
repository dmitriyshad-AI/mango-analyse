...
REAL_P0 = [
    ...
    "хочу снять ребёнка с кружка",
    "можно отказаться и выписать ребёнка с занятий?",
    "нужно перенести оплаченную смену, или вернёте деньги за смену?",
    "нужно перенести оплаченную смену",
    "в договоре неверная дата и фамилия ребёнка, исправьте",
