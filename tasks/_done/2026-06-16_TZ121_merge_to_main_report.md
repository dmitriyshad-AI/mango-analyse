...
- D — статус primary финализируется clean-источником `b00b3bd` в отдельной ветке `codex/tz125-finalize-group4`; грязная D-ветка `ce836b0` не является источником финального merge.
