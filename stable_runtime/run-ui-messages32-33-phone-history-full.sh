...
WAVE_ROOT="${PROJECT_ROOT}/stable_runtime/messages32_33_phone_history_full_20260422"
...
export MANGO_UI_DATABASE_PATH="${WAVE_ROOT}/messages32_33_phone_history_full_20260422.db"
