...
| `/Users/dmitrijfabarisov/Projects/Mango_timeline_owner_relink_fix_20260805` | `codex/timeline-family-canonical-owner-20260806`; SHA через `git rev-parse HEAD` | Устранение повторного owner-решения в семейном графе; только код, тесты и существующий APFS-клон staging. | После лестницы 1→10→всё, audit pack, слияния в `main` и отдельного подтверждения владельца. |
